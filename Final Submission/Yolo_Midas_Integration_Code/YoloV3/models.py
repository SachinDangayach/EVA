...
class Darknet(nn.Module):
    ...
    def __init__(self, cfg, img_size=(416, 416), verbose=False):
        ...
        # start 1
        self.module_list = torch.load('combined_bottleneck')
        # end 1
    ...
    def forward_once(self, x, augment=False, verbose=False):
        ...
        # start 2
        ## in case we are not taking out as argument, dont load below file
        out = torch.load('outs')
        yolo_out, out = [], [i.to(device) for i in out]
        # end 2
        if verbose:
            print('0', x.shape)
            str = ''
        ...
        # start 3
        for i, module in enumerate(self.module_list[37:]):
        # end 3
